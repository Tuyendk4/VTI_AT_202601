...
//    leftMenu = new LeftMenu(webUI);
  ...
  private String getRepoName() {
    return OBJECT_REPOSITORY_FOLDER_PATH + File.separator + repoName + ".json"; // /Users/tuyenluu/training-workspace/VTI_AT_202601/UiFramework/src/main/resources/object_repository/EmployeesPage.json
  }
