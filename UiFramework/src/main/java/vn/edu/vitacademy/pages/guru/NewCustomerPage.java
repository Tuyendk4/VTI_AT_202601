...
/**
 * Guru99 "Add New Customer" form (addcustomerpage.php).
 *
 * <p>Reference implementation for the Excel-driven validation pattern: it maps
 * each spreadsheet scenario ("Verify Name Field", "Verify PIN Field", ...) to
 ...
 */
public class NewCustomerPage extends GuruBankBasePage {
  ...
  protected String[] resolveFieldTarget(BankTestCase testCase) {
    ...
    if (scenario.contains("name") && !scenario.contains("label")) {
      return new String[] {"TXT_NAME", "LBL_NAME_ERROR"};
    }
